...
<link rel="icon" type="image/jpeg" href="{{ asset('images/favicon.ico') }}">
<style>
/* ============================================================
  ...
  <div class="container">
    <nav>
      <a href="#home" class="logo">
        <img src="{{ asset('images/logod.png') }}" alt="Sri Vayaluran Herbals" class="logo-mark">
...
<section class="hero" id="home">
  ...
  <div class="hero-grid">
    <div class="hero-content">
      <img src="{{ asset('images/logoa.jpeg') }}" alt="Sri Vayaluran Herbals" class="hero-emblem">
