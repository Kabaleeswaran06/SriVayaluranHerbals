  ...
  <div class="container">
    <nav>
      ...
      <div class="nav-actions">
        ...
        <a href="<?php echo e(route('admin.login')); ?>" class="icon-btn" aria-label="Admin login"><i class="fa-solid fa-shield-halved"></i></a>
  ...
  <div class="hero-grid">
    ...
    <div class="hero-visual">
      <div class="hero-shop-frame">
        ...
        <img src="<?php echo e(asset('images/shop-main.jpeg')); ?>" alt="Sri Vayaluran Herbals shop front" class="hero-shop-main">
        <img src="<?php echo e(asset('images/shop-detail.png')); ?>" alt="Inside Sri Vayaluran Herbals" class="hero-shop-float">
  ...
  <div class="container">
    ...
    <div class="product-toolbar reveal">
      ...
      <div class="filter-chips" id="filterChips">
        ...
        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <button class="chip" data-filter="<?php echo e($cat->id); ?>"><?php echo e($cat->name_en); ?></button>
    ...
    <div id="productCategories">
      <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="category-group reveal-stagger in-view" data-cat="<?php echo e($cat->id); ?>">
          <div class="category-heading">
            <h3><?php echo e($cat->name_en); ?></h3>
            <?php if($cat->name_ta): ?><span class="cat-ta"><?php echo e($cat->name_ta); ?></span><?php endif; ?>
          </div>
          <div class="product-grid">
            <?php $__currentLoopData = $cat->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <a href="<?php echo e(route('product.show', $product)); ?>" class="product-card" data-name="<?php echo e(strtolower($product->name_en)); ?>">
                <div class="product-jar"><?php echo \App\Support\ProductDisplay::visual($product, 96); ?></div>
                <div class="product-cat"><?php echo e($cat->name_en); ?></div>
                <h4><?php echo e($product->name_en); ?></h4>
                <?php if($product->name_ta): ?><div class="tamil-text" style="font-size:.78rem;color:#8a7f6a;margin-bottom:6px;"><?php echo e($product->name_ta); ?></div><?php endif; ?>
                <div class="product-price"><?php echo \App\Support\ProductDisplay::priceSummary($product); ?></div>
              </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
          <?php if($cat->total_products > $cat->showing_count): ?>
            <p class="category-more"><i class="fa-solid fa-circle-info"></i> Showing <?php echo e($cat->showing_count); ?> of <?php echo e($cat->total_products); ?> — more available in-store.</p>
          <?php endif; ?>
        </div>
    ...
    <?php if($allProducts->isNotEmpty()): ?>
      <div class="marquee-wrap">
          ...
          <div class="marquee-track">
            <?php for($i = 0; $i < 2; $i++): ?>
              <?php $__currentLoopData = $allProducts->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="marquee-item"><?php echo \App\Support\ProductDisplay::visual($product, 56); ?><span><?php echo e($product->name_en); ?></span></div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endfor; ?>
          </div>
        </div>
        <div class="marquee-row reverse">
          <div class="marquee-track">
            <?php for($i = 0; $i < 2; $i++): ?>
              <?php $__currentLoopData = $allProducts->reverse()->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="marquee-item"><?php echo \App\Support\ProductDisplay::visual($product, 56); ?><span><?php echo e($product->name_en); ?></span></div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endfor; ?>
          </div>
    ...
    <div class="container">
        ...
        <div id="comboCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-indicators">
                <?php $__currentLoopData = $combos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $combo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button type="button" data-bs-target="#comboCarousel" data-bs-slide-to="<?php echo e($i); ?>"
            ...
            <div class="carousel-inner rounded shadow-sm">
                <?php $__currentLoopData = $combos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $combo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="carousel-item <?php echo e($i === 0 ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('combos.show', $combo->slug)); ?>">
                            <img src="<?php echo e(Storage::url($combo->banner_image)); ?>"
                                 class="d-block w-100"
                                 alt="<?php echo e($combo->title); ?>">
                        </a>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
<section class="process-section" id="process">
  <div class="container">
    ...
    <div class="process-frame reveal">
      <video class="process-video" autoplay muted loop playsinline poster="<?php echo e(asset('images/shop-detail.jpg')); ?>">
        <source src="<?php echo e(asset('videos/process.mp4')); ?>" type="video/mp4">
      </video>
    ...
    <?php if($reviews->isNotEmpty()): ?>
      <div class="testimonial-carousel reveal" id="tCarousel">
        <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="t-card <?php echo e($loop->first ? 'active' : ''); ?>">
            <div class="t-stars"><?php echo e(str_repeat('★', $review->rating)); ?><?php echo e(str_repeat('☆', 5 - $review->rating)); ?></div>
            <p class="t-quote">"<?php echo e($review->review_text); ?>"</p>
            <div class="t-avatar"><?php echo e(strtoupper(substr($review->customer_name, 0, 1))); ?></div>
            <div class="t-name"><?php echo e($review->customer_name); ?></div>
            <div class="t-role"><?php echo e($review->role); ?></div>
          </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
...
<?php /**PATH C:\xampp\htdocs\SriVayaluranHerbals\resources\views/home.blade.php ENDPATH**/ ?>