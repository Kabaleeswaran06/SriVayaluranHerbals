...
<head>
  ...
  <title><?php echo e($category->name_en); ?> — Sri Vayaluran</title>
...
<body>
  ...
  <div class="cat-header">
    ...
    <h1><?php echo e($category->name_en); ?></h1>
    <?php if($category->name_ta): ?>
      <p class="ta"><?php echo e($category->name_ta); ?></p>
    <?php endif; ?>
    <div class="crumbs">
      <a href="<?php echo e(url('/')); ?>">Home</a><span>/</span>
      <a href="<?php echo e(route('shop.index')); ?>">All Categories</a><span>/</span>
      <span style="color:#fff;"><?php echo e($category->name_en); ?></span>
    </div>
  </div>
    ...
    <?php else: ?>
      <div class="prod-grid">
        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <a href="<?php echo e(route('product.show', $product)); ?>" class="prod-card">
            <div class="prod-img">
              <?php if($product->image_url ?? $product->image ?? false): ?>
                <img src="<?php echo e($product->image_url ?? asset('storage/'.$product->image)); ?>" alt="<?php echo e($product->name_en); ?>">
              <?php else: ?>
                🌿
              <?php endif; ?>
            </div>
            <div class="prod-body">
              <p class="prod-name"><?php echo e($product->name_en); ?></p>
              <?php if($product->name_ta): ?>
                <p class="prod-name-ta"><?php echo e($product->name_ta); ?></p>
              <?php endif; ?>
              <?php if($product->description): ?>
                <p class="prod-desc"><?php echo e(Str::limit($product->description, 70)); ?></p>
              <?php endif; ?>
              <?php $fromPrice = $product->from_price ?? $product->variants->min('price') ?? null; ?>
              <?php if($fromPrice): ?>
                <p class="prod-price"><small>From</small> &#8377;<?php echo e(number_format($fromPrice, 2)); ?></p>
              <?php endif; ?>
            </div>
          </a>
...
<?php /**PATH C:\xampp\htdocs\SriVayaluranHerbals\resources\views/shop/category.blade.php ENDPATH**/ ?>